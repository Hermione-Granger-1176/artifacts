window.ARTIFACTS_DATA = [
  {
    "id": "bond-price-vs-rate",
    "name": "Bonds vs Interest Rates",
    "description": "A plain-language explainer of why bond prices fall when interest rates rise: drag the rate to reprice a bond you own, see how coupon and maturity change the swing, and what the move means for the wider economy.",
    "tags": [
      "finance",
      "education",
      "visualization",
    ...
    "url": "apps/bond-price-vs-rate/",
    "thumbnail": "apps/bond-price-vs-rate/thumbnail.webp"
  },
  {
    "id": "loan-amortization",
    "name": "Loan Amortization Schedule",
    "description": "Interactive loan amortization calculator with charts, extra payment scenarios, and detailed repayment schedules.",
    "tags": [
      "finance",
      "calculator",
      "visualization"
