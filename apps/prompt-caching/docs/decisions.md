...
The artifact's sticky numbered progress nav is a genuinely useful long-form aid, so it was kept but restyled with shared tokens and placed below the standard app-shell header rather than replacing it.
